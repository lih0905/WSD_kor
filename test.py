...
if __name__ == "__main__":
    ...
    print(f"훈련 데이터 갯수는 {len(train_data)}개입니다.")
    print(f"검증 데이터 갯수는 {len(eval_data)}개입니다.")
...
#     eval_gloss_dict, eval_gloss_weight = dataloader_glosses(eval_data, tokenizer, urimal_dict, args.gloss_max_length)
    ...
    train_data = dataloader_context(train_data[:100], tokenizer, bsz=args.context_bsz, max_len=args.context_max_length)
